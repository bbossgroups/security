...
import com.frameworkset.platform.resource.Resource;
...
import com.frameworkset.platform.security.menu.MenuItemU;
import com.frameworkset.platform.security.util.CookieUtil;
import com.frameworkset.platform.util.LogManagerInf;
...
//					return token.getResourcedID().equals(rid);
	...
	public boolean isOrganizationManager(String orgId) {
		if(ConfigManager.getInstance().getPermissionModule() != null)
			return ConfigManager.getInstance().getPermissionModule().isOrganizationManager(orgId);
		return false;
	}
	...
	public boolean isSubOrgManager(String orgId) {
		if(ConfigManager.getInstance().getPermissionModule() != null)
			return ConfigManager.getInstance().getPermissionModule().isSubOrgManager(orgId);
		return false;
	}
	...
	public String getChargeOrgId() {
		if(ConfigManager.getInstance().getPermissionModule() != null)
			return ConfigManager.getInstance().getPermissionModule().getChargeOrgId();
		return null;
	}
