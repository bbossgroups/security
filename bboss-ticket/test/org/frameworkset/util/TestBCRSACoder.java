...
//		encodedData = Base64.hexStringToBytes(sss);
		...
		encodedData = ECCCoder.encrypt(data, ECCCoder.evalPublicKey(publicKey,ECCHelper.BCRSA));
		long end = System.currentTimeMillis();
		System.out.println("加密耗时:"+(end-start));
		
		start = System.currentTimeMillis();
		decodedData = ECCCoder.decrypt(encodedData, ECCCoder.evalPrivateKey(privateKey,ECCHelper.BCRSA));
