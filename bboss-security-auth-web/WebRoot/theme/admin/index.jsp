...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo <pg:equal actual="${theme }" value="admin_1">page-content-white page-sidebar-fixed</pg:equal> page-footer-fixed">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    <span class="username username-hide-on-mobile"> <admin:accesscontrol userattribute="title"/> </span>
                                    <i class="fa fa-angle-down"></i>
                                </a>
...
<![endif]-->
        ...
        <script src="../assets/pages/scripts/desktop-menus.js" type="text/javascript"></script>
